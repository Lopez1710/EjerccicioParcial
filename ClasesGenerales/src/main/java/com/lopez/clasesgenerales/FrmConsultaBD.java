 ...
 */
package com.lopez.clasesgenerales;
...
public class FrmConsultaBD extends javax.swing.JFrame {
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        ...
        Estudiantes esd = new Estudiantes();
        
        es.setNombre(txtNombre.getText());
        es.setApellido(txtApellido.getText());
        es.setUser(txtUser.getText());
        es.setPass(String.valueOf(txtPass.getPassword()));
        esd.AgregarEstudiante(es);
        Cargar();
